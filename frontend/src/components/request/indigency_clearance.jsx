...
const generateBarangayIndigency = async (request) => {
    try {
        ...
        page.drawText("CERTIFICATE OF INDIGENCY", { x: 200, y: 700, size: fontSize + 4, font, color: rgb(0, 0, 0) });
        ...
        const bodyTextLines = [
            ...
            "",
            "",
            `This is to certify that ${request.name} and  his/her family is classified as indigent resident of this barangay.`,
            "",
        ...
        link.download = `Barangay_Indigency_${request.name}.pdf`;
        link.click();
...
export default generateBarangayIndigency;