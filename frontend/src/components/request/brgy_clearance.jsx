...
const generateBarangayClearance = async (request) => {
    try {
        ...
        page.drawText("BARANGAY CLEARANCE", { x: 200, y: 700, size: fontSize + 4, font, color: rgb(0, 0, 0) });

        // Add the body text with 1.5 line spacing
        const bodyTextLines = [
            "TO WHOM IT MAY CONCERN:",
            "",
            `This is to certify that ${request.name}, ${request.age} years old, and a resident of ${request.address}, is known to be of good moral character and law-abiding citizen in the community.`,
            "",
            "",
            "",
            "",
        ...
        link.download = `Barangay_Clearance_${request.name}.pdf`;
        link.click();
...
export default generateBarangayClearance;